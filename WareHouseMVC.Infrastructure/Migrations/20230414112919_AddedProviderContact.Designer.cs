...
namespace WareHouseMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230414112919_AddedProviderContact")]
    partial class AddedProviderContact
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.CustomerAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.CustomerContactDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.ProductTag", b =>
                {
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.ProviderAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.ProviderContactDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.ProviderContactInformation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.ProviderAddress", b =>
                {
                    b.HasOne("WareHouseMVC.Domain.Model.Provider", "Provider")
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.ProviderContactDetail", b =>
                {
                    ...
                    b.HasOne("WareHouseMVC.Domain.Model.Provider", "Provider")
                        .WithMany("ProviderContactDetails")
                        .HasForeignKey("ProviderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.ProviderContactInformation", b =>
                {
                    b.HasOne("WareHouseMVC.Domain.Model.Provider", "Provider")
                        ...
                        .HasForeignKey("WareHouseMVC.Domain.Model.ProviderContactInformation", "ProviderRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WareHouseMVC.Domain.Model.Provider", b =>
                {
                    ...
                    b.Navigation("ProviderContactDetails");
